      ...
      <header className="flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
        <div className="flex items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbPage>SME Management</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        ...
        <div className="grid auto-rows-min gap-4 md:grid-cols-3">
          <div className="bg-muted/50 aspect-video rounded-xl p-4">
            <h3 className="font-semibold">Total SMEs</h3>
            <p className="text-2xl font-bold">1,234</p>
          </div>
          <div className="bg-muted/50 aspect-video rounded-xl p-4">
            <h3 className="font-semibold">Active SMEs</h3>
        ...
        <div className="bg-muted/50 min-h-[400px] flex-1 rounded-xl p-4">
          ...
          <p className="text-muted-foreground">
            SME management interface will be implemented here.
          </p>
        </div>
      </div>
    </>
