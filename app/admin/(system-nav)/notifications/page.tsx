      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        ...
        <div className="grid auto-rows-min gap-4 md:grid-cols-3">
          <div className="bg-muted/50 aspect-video rounded-xl p-4">
            <h3 className="font-semibold">Total Notification</h3>
            <p className="text-2xl font-bold">1,234</p>
          </div>
          <div className="bg-muted/50 aspect-video rounded-xl p-4">
            <h3 className="font-semibold">Active Notification</h3>
            <p className="text-2xl font-bold">1,156</p>
          </div>
          <div className="bg-muted/50 aspect-video rounded-xl p-4">
            <h3 className="font-semibold">Pending Approval Notification</h3>
